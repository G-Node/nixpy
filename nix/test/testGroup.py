...
class TestGroup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.my_group = self.block.create_group("my group", "tag", [0])

        self.your_array = self.block.create_data_array("your array", "test", DataType.Int16, (1, ))
        self.your_group = self.block.create_group("your group", "group", [0])
    ...
    def test_group_retrieve_feature_data(self):
